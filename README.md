...
This module contains the STMicroelectronics Composer HAL source code.
...
This directory contains the platform source library associated with the external/drm_hwcomposer.
It's used to generate hwcomposer.drm_stm32mp1 module.
